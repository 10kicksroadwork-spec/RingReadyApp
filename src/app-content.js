...
export const SC_SESSIONS = [
  ...
  { week: 1, day: 'Tuesday', sessionType: 'Strength Maintenance', modality: 'Calisthenics', exercises: 'Pushups (feet elevated if advanced) | Pull-Ups (band if needed) | Pike Pushups | Dips (bench/parallel bars)', setsReps: '1-2 x 6-15 each', intensity: '0-2 RIR (stop 1-2 reps before failure)', rest: '60-120s', notes: 'Quality reps. If you can do more than 15 clean reps, progress leverage, tempo, or variation.' },
  ...
  { week: 2, day: 'Tuesday', sessionType: 'Strength Maintenance', modality: 'Calisthenics', exercises: 'Pushups (harder variation if needed) | Pull-Ups | Pike Pushups | Dips', setsReps: '1-2 x 6-15 each', intensity: '0-2 RIR', rest: '60-120s', notes: 'Add reps first; then make variation harder.' },
  ...
  { week: 3, day: 'Tuesday', sessionType: 'Strength Maintenance', modality: 'Calisthenics', exercises: 'Pushups | Pull-Ups | Pike Pushups | Dips', setsReps: '2 x 6-15 each', intensity: '0-2 RIR', rest: '60-120s', notes: 'Highest volume week. Keep all reps crisp; avoid true failure.' },
  ...
  { week: 4, day: 'Tuesday', sessionType: 'Strength Maintenance', modality: 'Calisthenics', exercises: 'Pushups | Pull-Ups | Pike Pushups | Dips', setsReps: '1-2 x 6-15 each', intensity: '0-2 RIR', rest: '60-120s', notes: 'Maintain. Do not force extra volume if sore.' },
  ...
  { week: 5, day: 'Tuesday', sessionType: 'Strength Maintenance (Strength Bias)', modality: 'Calisthenics', exercises: 'Pushups (hardest clean variation) | Pull-Ups (weighted backpack if available) | Pike Pushups | Dips', setsReps: '1-2 x 5-12 each', intensity: '0-2 RIR', rest: '90-150s', notes: 'Slightly lower rep focus; longer rest.' },
...
export const SPRINT_GUIDANCE = [
  ...
  'Input Sprint HR immediately after the sprint rep — don’t wait for it to climb as high as it will go. Then log Rest HR the instant 60 seconds rest is up, you will get 30 seconds of additional rest.',
  'The 85% run is warmup only. Take a couple minutes of rest after it (do not sit and get cold), then start the sprints. The 5 min walk is the cooldown after the last rep.',
];
