...
export const ACTIVE_SESSION_STORAGE_KEY = 'ringReadyActiveSprintSession';
...
export const REST_LOG_ALERT_REMAINING_SEC = 30;
export const REST_LOG_ALERT_HZ = 1046;
export const REST_LOG_ALERT_MS = 180;
export const REST_LOG_ALERT_INTERVAL_MS = 750;
