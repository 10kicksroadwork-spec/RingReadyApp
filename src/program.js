...
export const PROGRAM = [
  {
    ...
    workouts: [
      ...
      { day: 'Saturday/Sunday', type: 'Long Run + S&C', description: '45 min easy continuous run.', warmup: 'Dynamic Stretches (Video)', targetZone: '60-70%', targetBPM: 137, action: 'log' },
    ].map(addVideoLink),
  },
  {
    id: 'week-2',
    ...
    workouts: [
      ...
      { day: 'Thursday', type: 'Easy Run', description: '20 min easy jog (recovery).', warmup: 'Dynamic Stretches (Video)', targetZone: '60-70%', targetBPM: 137, action: 'log' },
      { day: 'Saturday/Sunday', type: 'Long Run + S&C', description: '50 min easy run.', warmup: 'Dynamic Stretches (Video)', targetZone: '60-70%', targetBPM: 137, action: 'log' },
    ].map(addVideoLink),
  },
  {
    id: 'week-3',
    ...
    workouts: [
      ...
      { day: 'Saturday/Sunday', type: 'Long Run + S&C', description: '60 min easy run.', warmup: 'Dynamic Stretches (Video)', targetZone: '60-70%', targetBPM: 137, action: 'log' },
    ].map(addVideoLink),
  },
  {
    id: 'week-4',
    ...
    workouts: [
      ...
      { day: 'Saturday/Sunday', type: 'Long Run + S&C', description: '45 min easy run.', warmup: 'Dynamic Stretches (Video)', targetZone: '60-70%', targetBPM: 137, action: 'log' },
    ].map(addVideoLink),
  },
  {
    id: 'week-5',
    ...
    workouts: [
      ...
      { day: 'Thursday', type: 'Easy Run', description: '20 min easy jog (recovery).', warmup: 'Dynamic Stretches (Video)', targetZone: '60-70%', targetBPM: 137, action: 'log' },
      { day: 'Saturday/Sunday', type: 'Fight-Pace Intervals', description: '3x3 min hard run : 1 min easy jog between rounds Total time in Minutes to be recorded is 11', warmup: '6 min jog; 2x50 m strides.\n\nCooldown (after the run): 5 min walk', targetZone: '90-95%', targetBPM: 172, action: 'log', intervalPlan: { reps: 3, workMinutes: 3, restMinutes: 1 } },
    ].map(addVideoLink),
  },
  {
    id: 'week-6',
